          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center" ref={heroRef}>
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="relative mx-auto max-w-xs sm:max-w-md md:max-w-lg lg:max-w-lg">
                ...
                <div className="absolute inset-0 bg-[#2F6BFF] rounded-3xl blur-3xl opacity-15 animate-pulse" />
                <div className="glass-panel rounded-3xl p-4 relative hover-lift">
                  <img
                  ...
                  {/* Floating AI assistant text overlay - Fixed visibility */}
                  <div className="absolute top-6 right-6 glass-panel-sm bg-black/60 backdrop-blur-md border border-white/20 text-xs px-3 py-2 rounded-lg animate-fade-in">
