  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
        ...
        <p className="text-xs sm:text-sm text-gray-500 mb-8 sm:mb-12">Last updated: July 7, 2025</p>

        <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none space-y-6 sm:space-y-8">
          <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
            Vayu X operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Vayu X is backed by Praesidio Care Private Limited, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
          </p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">Personal Information We Collect or Process</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">Personal Information Sources</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">We may collect personal information from the following sources:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">How We Use Your Personal Information</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">Depending on how you interact with us or which of the Services you use, we may use personal information for the following purposes:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">How We Disclose Personal Information</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">In certain circumstances, we may disclose your personal information to third parties for legitimate purposes subject to this Privacy Policy. Such circumstances may include:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Vayu X is backed by Praesidio Care Private Limited, a company incorporated under the laws of India. All services, products, and information are provided by Praesidio Care Private Limited through the Vayu X brand.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">Third Party Websites and Links</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">Children's Data</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">Security and Retention of Your Information</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-gray-700 mt-4 leading-relaxed">
              You may exercise any of these rights by contacting us using the contact details provided below. We will not discriminate against you for exercising any of these rights. We may need to verify your identity before we can process your requests, as permitted or required under applicable law.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mt-12 mb-4">International Transfers</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Please note that we may transfer, store and process your personal information outside the country you live in. When we transfer your personal information outside of India, we will rely on recognized transfer mechanisms and contractual safeguards as required by applicable Indian data protection laws, including the Digital Personal Data Protection Act, 2023.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:contact@byoncocare.com" className="text-blue-600 underline">contact@byoncocare.com</a> or contact us at ITI Layout, Somasundarapalya, Bengaluru, Karnataka, India 560102. For the purpose of applicable data protection laws, we are the data controller of your personal information.
            </p>
          </section>
        </div>
      </div>
