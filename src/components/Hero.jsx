...
export default function Hero() {
  return (
    <main className="bg-gradient-to-br from-[#fef9f7] to-[#fbfbfa] min-h-screen flex flex-col font-sans text-gray-800" role="main">
      {/* Header */}
      <header className="flex items-center justify-between px-6 md:px-16 py-6" role="banner" aria-label="Main site navigation">
        {/* Logo */}
        ...
        {/* Nav links */}
        <nav className="hidden md:flex space-x-8 text-sm text-gray-600" role="navigation" aria-label="Primary">
        ...
        <div>
          <button
            className="bg-black text-white text-sm px-6 py-2 rounded-full shadow hover:bg-gray-900 transition duration-200"
      ...
      {/* Hero Content */}
      <section
        className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-24 lg:px-32 mt-10 md:mt-24 gap-12 md:gap-20"
      ...
      >
        ...
        >
          {/* Tagline */}
          <div className="text-sm font-semibold mb-4" style={{ color: '#5e17eb' }}>
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-[500px] h-[360px] bg-[#5e17eb]/30 blur-3xl rounded-full z-0"
          />
          <motion.img
            src="/byonco-hero-illustration.webp"
            alt="AI-assisted healthcare comforting a female patient — conceptual digital illustration"
            className="w-full max-w-[540px] h-auto object-contain rounded-xl shadow-xl relative z-10"
