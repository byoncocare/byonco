...
export default function AboutByOnco() {
  return (
    <motion.section
      className="bg-[#fefcfb] py-20 px-6 md:px-20"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-8 text-left">
          {contentItems.map((item, index) => (
            <motion.div
              ...
              className="group bg-white p-6 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              role="region"
