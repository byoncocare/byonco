    ...
    <AnimatePresence>
      {showBanner && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-50 px-4 py-3 sm:px-6 bg-white dark:bg-gray-900 shadow-lg border-t border-gray-200 dark:border-gray-700 text-sm text-gray-800 dark:text-gray-200"
        >
