    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-400 text-white font-medium text-sm sm:text-base px-6 sm:px-7 py-3 rounded-md shadow-md transition-all duration-300 focus:outline-none"
