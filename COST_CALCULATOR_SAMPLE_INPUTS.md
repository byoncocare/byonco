...
## ✅ Complete Sample Inputs (Guaranteed to Return Results)
...
**Click "Calculate Cost"** → Should return results!
...
- **Radiation**: ✅ **CHECKED**
  ...
  - **Concurrent Chemotherapy**: ❌ Unchecked
- **Transplant**: ❌ Unchecked

**Step 4: Diagnostics & Follow-up**
- **PET-CT Scans**: `3`
- **MRI/CT Scans**: `6`
- **NGS Panel Testing**: ✅ **CHECKED**
- **OPD Consultations**: `15`
- **Follow-up Horizon**: `24 Months`

**Step 5: Insurance & Payment**
- **I have insurance coverage**: ✅ **CHECKED**
  - **Insurance Provider**: Select any (e.g., first one in list)
  - **Policy Type**: `Domestic`
  - **Customize coverage percentages**: ❌ Unchecked (use defaults)
...
1. ✅ **Country** - Must select a country
2. ✅ **Hospital Type** - Must select a tier
3. ✅ **Age Group** - Must select one
4. ✅ **Cancer Category** - Must select one
5. ✅ **Disease Type** - Must select a cancer type
6. ✅ **Stage** - Must select a stage
7. ✅ **Treatment Intent** - Must select one
8. ✅ **At least ONE treatment** - Must check Surgery, Chemo, Radiation, OR Transplant

### Common Mistakes:
- ❌ Leaving "Disease Type" empty
- ❌ Leaving "Stage" empty
- ❌ Not checking any treatment modality
- ❌ Leaving "Hospital Type" empty
...
1. **Step 1**: Select `India` → Select `Tier 2 - Speciality Hospital`
2. **Step 2**: 
   - `Adult (18-65)`
   - `Common`
   - `Breast Cancer`
   - `Stage II (Regional)`
   - `Curative`
3. **Step 3**: Check `Include Chemotherapy` → Select `Standard Chemotherapy`
